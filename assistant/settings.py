...
SGA_API_TOKEN_APPUTEQ = os.getenv("SGA_API_TOKEN_APPUTEQ") or os.getenv("SGA_API_TOKEN_FIJO", "")
SGA_API_USUARIO = os.getenv("SGA_API_USUARIO", "")
SGA_API_CONTRASENIA = os.getenv("SGA_API_CONTRASENIA") or os.getenv("SGA_API_PASSWORD", "")
